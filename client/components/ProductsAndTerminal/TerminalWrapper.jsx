...
const TerminalWrapper = ({categories, managerView, setManagerView, cashOpen, category, setCategory, allProducts, products, setProducts, selectedProducts, page, setPage, currentOrder, setCurrentOrder, quantity, setQuantity, taxRate, setTaxRate, tax, total}) => {
  ...
  if(!managerView) { return (
    <Box sx={{display:'flex', alignItems:'center', width:'100%', height:'87vh', margin:'0'}}>
      ...
      <div style={{width:'100%', display:'flex', flexDirection:'column', alignItems:'center'}}>
        ...
        <ProductGrid products={selectedProducts} currentOrder={currentOrder} setCurrentOrder={setCurrentOrder} quantity={quantity} setQuantity={setQuantity} taxRate={taxRate} setTaxRate={setTaxRate} />
