...
const Terminal = ({lineItems, managerView, setCurrentOrder, currentOrder, tax, total, cashOpen, changeOpen}) => {
  ...
  return (
    <Box sx={{display:'flex', width:'100%', height:'80%', justifyContent:'center'}}>
      <Box sx={{height:'100%', alignSelf:'center', backgroundColor:'white', width: '85%', border:'1px solid black', borderRadius:'5px', margin:'0', marginTop:'1rem', marginRight:'.5rem', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'flex-end'}}>
