...
import {deleteProduct, deleteOrder} from '../../store/index';

const ManagementTableToolbar = ({ selected, setSelected, display}) => {
    ...
    >
      {selected.length > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          {display === 'inventory' ? 'Products' : 'Orders'}
        </Typography>
      )}
...
export default ManagementTableToolbar